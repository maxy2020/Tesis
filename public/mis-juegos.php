				...
				<table class="table table-bordered table-striped">
			        ...
			        <?php
			        	foreach ($games as $game) {
				            ...
				            echo '    <td class="td-name">'.$game['title'].'</td>';
				            echo '    <td class="ed"><a href="editar-juego.php?id='.$game['idvideogame'].'" class="bttn edit">EDITAR</a></td>';
				            echo '    <td class="del"><a href="javascript:void(0)" class="bttn delete" data-id="'.$game['idvideogame'].'" >BORRAR</a></td>';
				            echo '</tr>';
				        }
			        ?>
			    </table>
